...
export default function Form2({setForm,form}) {
    // Keyboard.show()
    return (
        <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
            <Text style={styles.text}>What's your email?</Text>
            <TextInput style={styles.input} keyboardType='email-address' autoCapitalize="none" placeholder="Your email" selectionColor="white" placeholderTextColor="rgba(255,255,255,0.5)"/>
