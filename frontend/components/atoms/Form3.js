...
export default function Form3({setForm,form}) {
    // Keyboard.show()
    return (
        <KeyboardAvoidingView style={styles.container} behavior="padding" enabled>
            <Text style={styles.text}>Choose your password</Text>
            <TextInput style={styles.input} keyboardType='email-address' autoCapitalize="none" placeholder="Your Password" selectionColor="white" placeholderTextColor="rgba(255,255,255,0.5)"/>
